...
export const environment = {
  ...
  // apiJobs: 'http://192.168.254.174:5506/api/v1/',
  // apiUrlTreasury: 'http://192.168.254.174:5510/api/v1/',
  // apiEducacionContinua: 'http://192.168.254.174:5510/api/v1/'
  ...
  consultaEstudiante: 'http://localhost:5032/api/Cedula/DataqueryCedula/GetDataCedula/',
  consultaPlanesAprobados: 'http://localhost:7180/api/v1/AnnualPlan/GetAll?StatusId=5',
  ConsultaMallaCurrcularByPlan: 'http://localhost:7180/api/v1/AnnualPlan/GetDegreeCurriculumDesignsBy?AnnualPlanId=',
  apiEC: "http://localhost:5032/api/v1/",
  apiForo: "https://foro-escuela-judicial.apps.revisados-attt.8ckj.p1.openshiftapps.com/api/v1/",
  apiCatalogs: 'http://localhost:5032/api/',
  apiUrlEF: 'http://localhost:7180/api/v1/Subject/',
  apiUrlEC: 'http://localhost:7179/api/v1/Activity/',
  apiEF: "http://localhost:7180/api/v1/",
  apiUrlDocument: 'http://localhost:5059/api/v1/RequiredDocument/',
  apiIntranet: 'http://localhost:5265/',
  apiUrlSubjectTask: "http://localhost:5265/SearchSubjectTask",
  apiEira: 'http://localhost:5265/',
  apiDocument: 'http://localhost:5032/api/v1/',
  apiExtUrlDependencies: 'http://localhost:5032/api/Cedula/DataqueryCedula/getDepInfo',
  apiSharedUrl: 'http://localhost:7201/api/v1/Shared/',
  apiJobs: 'https://jobboard-escuela-judicial.apps.revisados-attt.8ckj.p1.openshiftapps.com/api/v1/',
  apiUrlTreasury: 'https://treasuryservice-escuela-judicial.apps.revisados-attt.8ckj.p1.openshiftapps.com/api/v1/',
  apiEducacionContinua: 'https://treasuryservice-escuela-judicial.apps.revisados-attt.8ckj.p1.openshiftapps.com/api/v1/',
  apisignature: 'http://localhost:7254/api/v1/'
};
