...
@Component({
  selector: 'app-enrollment-direct-schedule-list',
  templateUrl: './enrollment-direct-schedule-list.component.html',
  styleUrls: ['./enrollment-direct-schedule-list.component.scss']
})
export class EnrollmentDirectScheduleListComponent extends UnsubscribeOnDestroyAdapter
  implements OnInit{
  displayedColumns = [
    'name',
    'description',
  ...
  ViewDetail(row:ScheduleActivity) {
    this.router.navigate(['/admission/ed-activity-list-inscription',row.id]);
  }
