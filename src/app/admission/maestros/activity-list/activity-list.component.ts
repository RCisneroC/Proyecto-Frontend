...
export class ActivityListComponent extends UnsubscribeOnDestroyAdapter
implements OnInit{
    ...
    this.subs.sink = dialogRef.afterClosed().subscribe((result) => {
      if (result === 1) {
        ...
        this.exampleDatabase?.dataChange.value.unshift(
          this.activityService.getDialogData()
        );
        this.refreshTable();
...
export class ExampleDataSource extends DataSource<Activity> {
  ...
  connect(): Observable<Activity[]> {
    ...
    this.exampleDatabase.getAllActivity();
