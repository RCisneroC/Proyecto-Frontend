...
export class ReasonListComponent  extends UnsubscribeOnDestroyAdapter
implements OnInit{
  ...
  public loadData() {
    this.exampleDatabase = new ReasonService(this.httpClient);
...
export class ExampleDataSource extends DataSource<Reason> {
  ...
  renderedData: Reason[] = [];
  constructor(
    public exampleDatabase: ReasonService,
  ...
  connect(): Observable<Reason[]> {
    ...
    this.exampleDatabase.getAllReason();
      ...
      map(() => {
        ...
        this.filteredData = this.exampleDatabase.data
          ...
          .filter((reason: Reason) => {
            const searchStr = (reason.name).toLowerCase();
