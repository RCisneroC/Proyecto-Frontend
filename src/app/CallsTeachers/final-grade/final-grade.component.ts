  ...
  volverAtras() {
    ...
    if(local=="1"){
      if(this.typeUser==="Administrador"){
        this._Router.navigate(['/calls-teachers/teacher-history-list/',localStorage.getItem('cedula')]);
      }else{
        this._Router.navigate(['/calls-teachers/teacher-history-list/']);
      }
    }else{
      if(this.typeUser==="Administrador"){

        this._Router.navigate(['/calls-teachers/career-list/',localStorage.getItem('cedula')]);
      }else{
        this._Router.navigate(['/calls-teachers/career-list/']);
      }
    }
  }
