...
export class ApprovedSolicitudComponent {
  ...
  RequestVariousApproved: RequestVarious;
  ...
  createContactForm(): UntypedFormGroup {
    return this.fb.group({
      idSolicitud: [this.data.id, [Validators.required]],
  ...
  submit() {
    ...
    if (this.action === 'edit') {
      ...
      this._DataLocal[parseInt(this.data.id)].statusId = this.RequestVariousApprovedForm.controls['statusId'].value
      console.log('====================================');
