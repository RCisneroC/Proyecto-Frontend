...
@Component({
  ...
  templateUrl: './list-task-subject.component.html',
  styleUrls: ['./list-task-subject.component.scss']
})
export class ListTaskSubjectComponent extends UnsubscribeOnDestroyAdapter
  implements OnInit {
  ...
  exampleDatabase?: SubjectListService;
  ...
  public loadData() {
    this.exampleDatabase = new SubjectListService(this.httpClient);
...
export class ExampleDataSource extends DataSource<Subject> {
  ...
  constructor(
    public exampleDatabase: SubjectListService,
