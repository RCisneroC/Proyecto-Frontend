...
export class ProductListComponent extends UnsubscribeOnDestroyAdapter
  implements OnInit {
  ...
  exampleDatabase?: ProductService;
    ...
    this.subs.sink = dialogRef.afterClosed().subscribe((result) => {
      ...
      if (result === 1) {
        ...
        this.exampleDatabase?.dataChange.value.unshift(
          this.productService.getDialogData()
        );
        this.refreshTable();
        Swal.fire({
...
export class ExampleDataSource extends DataSource<Product> {
  ...
  constructor(
    public exampleDatabase: ProductService,
  ...
  connect(): Observable<Product[]> {
    ...
    this.exampleDatabase.getAllProduct();
      ...
      map(() => {
        ...
        this.filteredData = this.exampleDatabase.data
          ...
          .filter((product: Product) => {
            const searchStr = (product.name).toLowerCase();
