...
@Component({
  selector: 'app-subject-score-list',
  templateUrl: './subject-score-list.component.html',
  styleUrls: ['./subject-score-list.component.scss']
})
export class SubjectScoreListComponent extends UnsubscribeOnDestroyAdapter
  implements OnInit{
  ...
  addNew() {
    ...
    const dialogRef = this.dialog.open(FormSubjComponent, {
      data: {
    ...
    return merge(...displayDataChanges).pipe(
      map(() => {
        ...
        this.filteredData = this.exampleDatabase.data
          ...
          }).filter( x=> x.category == "Asignatura");
        // Sort filtered data
