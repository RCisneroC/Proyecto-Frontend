...
@Component({
  selector: 'app-activity-score-list',
  templateUrl: './activity-score-list.component.html',
  styleUrls: ['./activity-score-list.component.scss']
})
export class ActivityScoreListComponent extends UnsubscribeOnDestroyAdapter
  implements OnInit{
